...
const HeaderVariant = ({ bgColor, fontWeight }) => {
  ...
  return (
    <nav className={`border-gray-200 dark:bg-gray-900 ${bgColorClass}`}>
      <div className="max-w-screen-xl 2xl:max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          <span className="font-light">teeenage engineering</span>
        </Link>
        <button
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul
            className={`flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 ${fontWeightClass}`}
          >
            <li>
              <Link
                href="/"
