...
const Header = () => {
  return (
    <header className="light">
      <nav class="light bg-white border-gray-20">
          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:border-gray-700">
              <li>
                <Link
                  href="/"
                  class="block py-2 px-3 text-black md:hover:text-orange-600 rounded md:bg-transparent md:p-0"
                  aria-current="page"
                >
                  Home
                </Link>
              ...
              <li>
                <Link
                  href="/"
                  class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-600 md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                >
                  About
                </Link>
              </li>
